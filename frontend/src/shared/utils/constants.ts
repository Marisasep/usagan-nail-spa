...
export const SERVICES: Service[] = [
  {
    id: 'spa-hand-foot',
    name: 'สปามือและเท้าพรีเมียม 8 ขั้นตอน',
    description: 'ปรนนิบัติมือและเท้า ด้วยสปาเข้มข้น 8 ขั้นตอน',
    price: 799,
    duration: 90,
    category: 'spa',
  ...
  },
  {
    id: 'gel-nail',
    name: 'ทำเล็บเจล',
    description: 'ทำเล็บเจลสวยด้วยวัสดุพรีเมียม',
    price: 590,
    duration: 60,
    category: 'nail',
  ...
  },
  {
    id: 'nail-extension',
    name: 'ต่อเล็บ',
    description: 'บริการต่อเล็บโดยช่างมืออาชีพ',
    price: 990,
    duration: 120,
    category: 'nail',
  ...
  },
  {
    ...
    name: 'ต่อขนตา',
    description: 'ต่อขนตาธรรมชาติสวยงาม',
    price: 890,
    duration: 90,
    category: 'eyelash',
  ...
  {
    id: 'mani-pedi',
    name: 'ทำเล็บมือและเท้า',
    description: 'ทำเล็บมือและเท้าแบบคลาสสิก',
    price: 450,
    duration: 60,
    category: 'nail',
  ...
  {
    id: 'nail-spa-package',
    name: 'แพ็คเกจเล็บ + สปา',
    description: 'แพ็คเกจทำเล็บพร้อมสปาครบวงจร',
    price: 1290,
    duration: 150,
    category: 'package',
